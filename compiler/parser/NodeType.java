...
public enum NodeType {
    ...
    public static NodeType fromTokenType(TokenType token) {
        ...
        switch(token) {
        case Comparison       :
            coercedType = NodeType.Comparison;
            break;
        case BooleanOp        :
            coercedType = NodeType.BooleanOp;
            break;
        case NumberOp         :
            coercedType = NodeType.NumberOp;
            break;
        case String           :
            coercedType = NodeType.String;
            break;
        case Assignment       :
            coercedType = NodeType.Assignment;
            break;
        case Control          :
            coercedType = NodeType.Control;
            break;
        case IO               :
            coercedType = NodeType.IO;
            break;
        case Integer          :
            coercedType = NodeType.Integer ;
            break;
        case Halt             :
            coercedType = NodeType.Halt ;
            break;
        case UserDefinedName  :
            coercedType = NodeType.UserDefinedName;
            break;
        case Procedure        :
            coercedType = NodeType.Procedure;
            break;
        case Grouping         :
            coercedType = NodeType.Grouping;
            break;
        case ShortString      :
            coercedType = NodeType.ShortString ;
            break;
        }
        return coercedType;
    }
